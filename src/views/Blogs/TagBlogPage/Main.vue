<template>
  <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
    <h2 class="text-lg font-medium mr-auto">Chủ đề</h2>
            ...
            <div class="grid grid-cols-2 gap-5">
              ...
              <div class="text-left mb-5 col-span-2">
                ...
                <textarea  type="text"
                  class="form-control"
                  placeholder="Mô tả"
                  v-model="inputValue.descript"></textarea>
              </div>
            </div>
          </div>
...
const initTabulator = () => {
  tabulator.value = new Tabulator(tableRef.value, {
    ajaxURL: `${BASE_URL}/tag-blog/get-all`,
    headerHozAlign: "left",
