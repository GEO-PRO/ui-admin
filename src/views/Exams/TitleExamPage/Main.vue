...
const handleCreate = () => {
  ...
  axios({
    url: `${BASE_URL}/title-exam/create`,
    method: "POST",
...
const handleSubmitDelete = () => {
  axios({
    url: `${BASE_URL}/title-exam/delete`,
    method: "POST",
...
const handleSubmitUpdate = () => {
  ...
  axios({
    url: `${BASE_URL}/title-exam/update`,
    method: "POST",
...
const initTabulator = () => {
  tabulator.value = new Tabulator(tableRef.value, {
    ajaxURL: `${BASE_URL}/title-exam/get-all`,
    headerHozAlign: "left",
