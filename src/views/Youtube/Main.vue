<template>
  <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
    <h2 class="text-lg font-medium mr-auto">Youtube</h2>
...
const initTabulator = () => {
  tabulator.value = new Tabulator(tableRef.value, {
    ajaxURL: `${BASE_URL}/youtube/get-all`,
    headerHozAlign: "left",
    ...
    columns: [
      ...
      },
      {
        ...
        vertAlign: "middle",
        formatter(cell) {
          return `<a href=${cell.getData().link} target="_blank">${
            cell.getData().link
          }</a>`;
        },
      },
